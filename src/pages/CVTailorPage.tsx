...
// API configuration - Consider moving this to environment variables
const GEMINI_API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-05-20:generateContent";
// We'll use a placeholder and recommend environment variables
  ...
  const createProfessionalDocument = (sections: { [key: string]: string[] }, candidateName: string): Document => {
    ...
    if (sections['HEADER'].length > 0) {
      ...
      if (contactLines.length > 0) {
        // Create a single paragraph with all contact info separated by pipes
        ...
        <div style={{
          ...
          {activeTab === 'manual' ? (
            ...
            <div>
              ...
              >
                <input {...getInputProps()} />
                <div style={{fontSize: '2.5rem', color: isDragActive ? 'var(--primary-blue)' : '#ccc', marginBottom: '1rem'}}>
                  {isDragActive ? '📄' : '📄'}
                </div>
                {isDragActive ? (
                  ...
                  <div>
                    <p>Drag and drop your resume file here, or click to select</p>
